...
<body>
    ...
    <div class="main-container">
        <div class="sidebar">
            <div class="dropdown"><button class="btn text-white">ASSETS</button>
                <ul class="dropdown-menu">
                    <li><a href="/OutDoorMedia/media/add">Add Asset</a></li>
                    <li><a href="${pageContext.request.contextPath}/media/assets">Asset List</a></li>
                </ul>
            </div>
            ...
            <div class="dropdown"><button class="btn text-white">CONTENT</button>
                <ul class="dropdown-menu">
                    ...
                    <li><a href="${pageContext.request.contextPath}/content/contents">Content List</a></li>
                </ul>
            </div>
            <div class="dropdown"><button class="btn text-white">PAYMENT</button>
                <ul class="dropdown-menu">
                    <li><a href="/OutDoorMedia/payment/add">Add Payment</a></li>
                    <li><a href="${pageContext.request.contextPath}/payment/payments">Payment List</a></li>
                </ul>
            </div>
            <div class="dropdown"><button class="btn text-white">USERFEEDBACK</button>
                <ul class="dropdown-menu">
                    ...
                    <li><a href="${pageContext.request.contextPath}/userfd/userFeedback">UserFeedback List</a></li>
                </ul>
            </div>
            <div class="dropdown"><button class="btn text-white">USER</button>
                <ul class="dropdown-menu">
                    <li><a href="/OutDoorMedia/user/add">Add User</a></li>
                    <li><a href="${pageContext.request.contextPath}/user/users">User List</a></li>
                </ul>
            </div>
            <div class="dropdown"><button class="btn text-white">ROLE</button>
                <ul class="dropdown-menu">
                    <li><a href="/OutDoorMedia/role/add">Add Role</a></li>
                    <li><a href="${pageContext.request.contextPath}/role/roles">Role List</a></li>
                </ul>
            </div>
        </div>
